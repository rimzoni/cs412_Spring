    ...
    return (
      ...
      { this.props.task.tasks.map((task, key) => {
                return (
                    ...
                    <Feed.Label>
                      <Icon name='pencil' />
                      <Feed.Summary date={task.name} user={task.status} content={task.description} />
                    </Feed.Label>
                    <Feed.Meta like={task.id} />
                    </Feed.Content>
                    </Feed.Event>
                  )
                 })
      ...
      <Table celled padded>
        <Table.Header>
         <Table.Row>
          ...
          <Table.HeaderCell>Add_008</Table.HeaderCell>
         ...
         { this.props.task.tasks.map((task, key) => {
                   return (
                      <Table.Row key={key}>
                        ...
                        <Table.Cell>{task.add_008}</Table.Cell>
