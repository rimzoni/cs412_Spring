...
import { Button, Form, Table, Container,  Checkbox, Feed } from 'semantic-ui-react'
    ...
    return (
      ...
      <Feed>
         { this.props.task.tasks.map((task, key) => {
                   return (
                     <Feed.Event>
                     <Feed.Label><i aria-hidden="true" class="pencil icon"></i></Feed.Label>
                      <Feed.Content key={key}>
                        ...
                        <Feed.Meta>
                        <Feed.Like>
                        <i aria-hidden="true" class="like icon"></i>{task.id} Likes
                        </Feed.Like>
                        </Feed.Meta>
                      </Feed.Content>
                      </Feed.Event>
