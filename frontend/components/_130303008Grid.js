...
class _130303008Grid extends Component {
  constructor () {
    super()
    this.state = {
      departments: []
    ...
    return (
      ...
      <Header />
       ...
       <form onSubmit={this.handleSubmit2}>
         <label htmlFor="id">Enter the id to search: &nbsp;&nbsp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; </label>
