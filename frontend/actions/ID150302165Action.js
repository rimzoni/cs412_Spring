...
function shouldFetchData ({ projectProps }) {
  return !ID150302165.ID150302165 || !ID150302165.isFetching
}
...
function fetchRecord () {
  return (dispatch, getState) => {
    if (shouldFetchData(getState())) {
      apiProps.url = url
      apiProps.types.request = 'REQUEST_RECORD'
      apiProps.types.receive = 'RECEIVE_RECORD'
