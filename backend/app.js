...
app.get('/departmentsById', (req, res) => {
  //console.log(req.query.name)
  Table.byDepartment(req.query.id)
		.then(function (departments) {
		  res.status(200)
			.json(departments)
		})
...
pp.get('/departmentsByDepartment', (req, res) => {
  //console.log(req.query.name)
  Table.byDepartment(req.query.department)
		.then(function (departments) {
		  res.status(200)
			.json(departments)
		})
...
// app.get('/departmentsById', (req, res) => {
//   let departmentsId = req.query.id
//   Table.forge({id: departmentsId}).fetch().then(function (departments) {
//     if (!departments) {
